...
formula2ddlog_lib/target/debug/formula2ddlog_lib benchmark/graph/graph.4ml > benchmark/graph/graph.dl &&
...
ddlog -i benchmark/graph/graph.dl -L ~/differential-datalog/lib/